...
namespace DePascalizationSpecification
{
    public class DepascalizationSpecification
    {
      ...
      public void ShouldAllowDepascalizationOfNUnitReportXml()
      {
        ...
        {
          XAssert.Equal(splitExpected[i].Trim(), splitResult[i].Trim(), i.ToString());
        }
      }
            ...
            <results>
              <test-suite type=""TestFixture"" name=""Any Specification"" executed=""True"" result=""Success"" success=""True"" time=""5.182"" asserts=""0"">
                <results>
                  ...
                  <test-case name=""TddToolkit Specification. Any Specification. should override virtual methods that throw exceptions on sbstract class proxy"" executed=""True"" result=""Success"" success=""True"" time=""0.009"" asserts=""0"" />
              ...
              <test-suite type=""TestFixture"" name=""ConstraintsViolations Specification"" executed=""True"" result=""Success"" success=""True"" time=""0.330"" asserts=""0"">
                <results>
                  ...
                  <test-case name=""TddToolkit Specification. ConstraintsViolations Specification. should throw exception containing all violation messages when more than one violation was sdded"" executed=""True"" result=""Success"" success=""True"" time=""0.318"" asserts=""4"" />
